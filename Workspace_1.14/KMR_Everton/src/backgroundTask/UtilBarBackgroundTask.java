 ...
 * 
 */
public class UtilBarBackgroundTask extends RoboticsAPIBackgroundTask
{
    ...
    private void initUtilBar ()
    {
        ...
        _utilBar = getApplicationUI().createUserKeyBar("Gripper");
        IUserKeyListener listenerWorkpiece = new IUserKeyListener()
        {
            ...
            public void onKeyEvent(IUserKey key, UserKeyEvent event)
            {
            	if(festoIO.getIn_2_7_AxisIsReferenced()){
	                ...
	                {
	                	_gripper.prepareSensitiveMove((Integer) getApplicationData().getProcessData("closeForceVial").getValue());
	            		_gripper.moveSensitive(1);
	              ...
	              {
	            		_gripper.prepareSensitiveMove((Integer) getApplicationData().getProcessData("closeForceCartridge").getValue());
	              		_gripper.moveSensitive(1);
        ...
        openKey5.setText(UserKeyAlignment.TopMiddle, "prepare grasp vial");
